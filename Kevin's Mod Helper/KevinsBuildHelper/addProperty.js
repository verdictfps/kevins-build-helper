...
function attField() {
    ...
    console.log("Field added to all attachments in Attachments.json.");
}
function barField() {
    ...
    console.log("Field added to all barrels in Barrels.json.");
}
function optField() {
    const fs = require("fs");
    ...
    console.log("Field added to all optics in Optics.json.");
}
function chamField() {
...
function lasField() {
    ...
    console.log("Field added to all lasers in Lasers.json.");
}
function fireField() {
