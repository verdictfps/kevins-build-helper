...
const INPUT_FILE = "./itemdata/Optics.json";
const OUTPUT_FILE = "./itemdata/Optics.json";
...
// UPDATE ALL OILS
for (const oilName in oils.Optic) {
    console.log(oils.Optic[oilName]);
    oils.Optic[oilName].DropdownDescription =
    buildDescription(oils.Optic[oilName]);
}
